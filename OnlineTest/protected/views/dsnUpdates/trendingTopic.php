...
<div class="dsn_notifications">
        	<div class="stream_title paddingt5lr10 bg_w"><a class="pull-left marginzero normaltext">Trending topic is</a> 
                  ...
                  <a   class="skiptaiconinner ">
                    ...
                    <b>  &nbsp; <?php  echo $topicDetails[0]->TopicName;?></b> </a> </div>
            ...
            <ul>
            <li class="media">
                 <?php if(sizeof($notification->Artifacts)>0){?>
