...
<div style="width:600px; padding: 0; margin:0 auto;">
    ...
    <tr>
        <td>
            ...
            <p style="font-size:14px;">Hello <b style="font-size:14px; font-weight:bold;"><?php echo $name ?></b>,</p>
            <p style="font-size:12px; font-weight:normal; padding-top: 20px">Congratulations! We have verified your credentials and are pleased to inform you that we have activated your account on <?php echo YII::app()->params['NetworkName']; ?>. As a member of this Skipta social network, you are now able to tap into the power of social media and begin communicating and collaborating with others within your specialty.</p>
            <p style="font-size:12px; font-weight:normal; padding-top: 20px">We encourage you to log onto the network at <a target="_blank" href="<?php echo YII::app()->params['ServerURL']; ?>"><?php echo YII::app()->params['ServerURL']; ?></a> and explore the innovative tools we have to offer. When you first log on, a helpful tutorial will guide you through the site.</p>
