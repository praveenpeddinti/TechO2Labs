...
<div class="normaloutersection normalouter_<?php echo $widgetCount; ?>">
     ...
     <div class="span2 positionrelative labelpercent">
          <div class="control-group controlerror">
              <input  type="text" class="textfield span10 distvalue_<?php echo $widgetCount; ?>" name = "ExtendedSurveyForm[PercentageAnswer][<?php echo $i."_".$widgetCount; ?>]"  id ="ExtendedSurveyForm_PercentageAnswer_<?php echo $i."_".$widgetCount; ?>" onkeydown="allowNumericsAndCheckFields(event)" onkeyup="maxCheck(this,<?php echo $widgetCount; ?>)" size="8" maxlength="4"/> <label class="percentlbl perUnitType_<?php echo $widgetCount; ?>"  > <?php echo $unitType; ?></label>
