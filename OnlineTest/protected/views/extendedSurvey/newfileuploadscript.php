<input type="hidden" name="ExtendedSurveyForm[QuestionImage][<?php echo $widgetCount; ?>]" id="ExtendedSurveyForm_QuestionImage_<?php echo $widgetCount; ?>" value="/images/system/survey_img.png" />
<div class="row-fluid">
    <div class="span12">
        <div class="span2">
...
initializeFileUploader('uploadfile_<?php echo $widgetCount; ?>', '/extendedSurvey/uploadImage?qId=<?php echo $widgetCount; ?>', '10*1024*1024', extensions, 1, 'SurveyImage', '', BrandPreviewImage, displayErrorForBannerAndQuestion, "appendlist_<?php echo $widgetCount; ?>");
    </script>