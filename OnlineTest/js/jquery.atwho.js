  ...
  (function(factory) {
    ...
    Controller = (function() {
      ...
      Controller.prototype.catch_query = function() {
        ...
        var content_split = content.substr(caret_pos);
        var content_split_sub = content_split.split(" ");        
        var content_split_sub1 = content_split_sub[0].split("@");
        var queryString = "";
        if(content_split_sub1.length > 0){
            queryString = content_split_sub1[0];            
        }
        //caret_pos = caret_pos + queryString.length;
      ...
      Controller.prototype.insert = function(content, $li) {
        ...
        if ($inputor.is('textarea, input')) {
         ...
         //pos = range.startOffset - (this.query.end_pos - this.query.head_pos) - this.at.length + this.query.extra_pos;          
         pos = range.startOffset - (this.query.end_pos - this.query.head_pos) - this.at.length;
          range.setStart(range.endContainer, Math.max(pos, 0));          
          //range.setEnd(range.endContainer, range.endOffset + this.query.extra_pos);
          ...
          range.moveStart('character', this.query.head_pos-this.query.end_pos-this.at.length);
          $insert_node.find('div').remove();
          range.pasteHTML($insert_node.html());
          range.collapse(false);
          range.select();
        }
        $inputor.focus();
