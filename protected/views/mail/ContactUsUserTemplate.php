<div style="width:600px; padding: 0; margin:0 auto;">
    ...
    <tr>
        <td>
            ...
            <p style="font-size:14px;">Hello <b style="font-size:14px; font-weight:bold;"><?php echo $firstName ?></b>,</p>
            <p style="font-size:12px; font-weight:normal; padding-top: 20px">Thank you for contacting us.
                We appreciate your feedback and we'll get back to you shortly.
                If you have forgotten your password, please use the "forgot password" option on the network's homepage.</p>
