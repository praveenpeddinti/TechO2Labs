 ...
 <table cellpadding="0" cellspacing="0" style="width:100%">
             <tr>
                 ...
                 <td style="border-top:1px solid #d9d9d9;border-right:1px solid #d9d9d9;padding:3px 10px;vertical-align:top">
                    ...
                    <tr>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-right:5px;padding-top:3px;padding-bottom:3px;vertical-align:top">A)</td>
                    <td style="width:20px;vertical-align:top;padding-top:0px;padding-bottom:5px;"><img src="<?php echo $siteurl; ?>/snipetshtmls/radiounchecked.png" style="border:0" /></td>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-left:5px;padding-top:3px;padding-bottom:3px;vertical-align:top"><?php  echo $data->OptionOne ?></td>
                    </tr>
                    <?php if(!empty($data->OptionThree)){ ?>
                    <tr>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-right:5px;padding-top:3px;padding-bottom:3px;vertical-align:top">B)</td>
                    <td style="width:20px;vertical-align:top;padding-top:0px;padding-bottom:5px;"><img src="<?php echo $siteurl; ?>/snipetshtmls/radiounchecked.png" style="border:0" /></td>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-left:5px;padding-top:3px;padding-bottom:3px;vertical-align:top"><?php  echo $data->OptionTwo ?></td>
                    </tr>
                    <?php } ?>
                    <?php if(!empty($data->OptionThree)){ ?>
                    <tr>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-right:5px;padding-top:3px;padding-bottom:3px;vertical-align:top">C)</td>
                    <td style="width:20px;vertical-align:top;padding-top:0px;padding-bottom:5px;"><img src="<?php echo $siteurl; ?>/snipetshtmls/radiounchecked.png" style="border:0"/></td>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-left:5px;padding-top:3px;padding-bottom:3px;vertical-align:top"><?php  echo $data->OptionThree ?></td>
                    </tr>
                    <?php } ?>
                    <?php if(!empty($data->OptionFour)){ ?>
                    <tr>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-right:5px;padding-top:3px;padding-bottom:3px;vertical-align:top">D)</td>
                    <td style="width:20px;vertical-align:top;padding-top:0px;padding-bottom:5px;"><img src="<?php echo $siteurl; ?>/snipetshtmls/radiounchecked.png" style="border:0"/></td>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-left:5px;padding-top:3px;padding-bottom:3px;vertical-align:top"><?php  echo $data->OptionFour ?></td>
                    </tr>
                    <?php } ?>
                    </table>
                    <div style="text-align:right;vertical-align:top">
                      <a href="<?php echo $url;?>" target="_blank"><img src="<?php echo $siteurl; ?>/snipetshtmls/submitbutton.png" style="border:0" /></a>
                    </div>
                    </td>
                    </tr>
                   </table>
                     ...
                     <table cellspacing="0" cellpadding="0" style="width:100%">
                    <tr>
                    <td style="width:220px;padding-top:7px;padding-bottom:7px;vertical-align:top">
                    <div style="border:2px solid #d0d0d0;padding:2px;">
                     <a href="<?php echo $url;?>" target="_blank" ><img style="width:100%;border:0" src="<?php echo $siteurl; ?>/snipetshtmls/surveyimg.png"></a>
                    </div>
                    </td>
                    <td style="padding-left:10px;vertical-align:top;padding-top:7px;padding-bottom:7px"> 
                     <table cellspacing="0" cellpadding="0">
                      <?php  if($data->OptionOne!=""){ ?>
                    <tr>
                    <td style="color:#333;font-family:arial;font-size:12px;padding-right:5px;padding-top:3px;padding-bottom:3px;vertical-align:top">A)</td>
