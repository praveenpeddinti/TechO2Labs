...
//        socketCurbside.emit('clearInterval',sessionStorage.old_key);
    ...
    getCollectionData('/curbsidePost/getTrendingDetails', 'StreamPostDisplayBean', 'curbsidePostsDiv', '<?php echo Yii::t('translation','No_Posts_found'); ?>',"<?php echo Yii::t('translation','Thas_all_folks'); ?>");
...
<script type="text/javascript">
  ...
  function CloseFilterData(activeid,divid){
       ...
       $("#curbsidePostsDiv").show();
        ...
        page = 1;
        isDuringAjax=false;
         getCollectionData('/curbsidePost/getcurbsideposts', 'StreamPostDisplayBean', 'curbsidePostsDiv', '<?php echo Yii::t('translation','No_Data_Found'); ?>',"<?php echo Yii::t('translation','Thas_all_folks'); ?>");
